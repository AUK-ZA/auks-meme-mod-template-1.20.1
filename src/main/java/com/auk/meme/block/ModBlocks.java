...
public class ModBlocks {
    ...
    public static final Block P_ORE = registerBlock("p_ore" ,
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.IRON_ORE),
                    UniformIntProvider.create(2,6)));//创建经验掉落方块实例

    public static final Block P_BLOCK = registerBlock("p_block" ,
            new Block(FabricBlockSettings.copyOf(Blocks.COAL_BLOCK)));//创建方块实例
